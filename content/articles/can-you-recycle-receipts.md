---
title: "Can You Recycle Receipts? What Actually Happens to Thermal Paper Waste"
date: "2026-06-04"
description: "Most receipts cannot be recycled — and putting them in the recycling bin makes things worse. Here's what happens when thermal paper enters the recycling system, where it ends up, and what to do with it instead."
slug: "can-you-recycle-receipts"
featured: false
---

# Can You Recycle Receipts? What Actually Happens to Thermal Paper Waste

The honest answer is: no, you should not recycle most receipts — and it's not just that they're a waste-stream nuisance. Putting a thermal receipt in your recycling bin actively makes the recycling process worse, spreading [BPA and BPS](/articles/the-science-of-bisphenols) into paper products you'd never expect.

But to understand why, it helps to understand what actually happens to that bin after you set it on the curb.
...
This is a rarely discussed angle: [workers](/articles/who-is-at-risk-from-thermal-paper-exposure) at paper mills and recycling facilities who handle large volumes of mixed paper are exposed to BPA through the same skin-contact mechanism that affects [cashiers](/articles/2026-cashiers-safety-guide). When receipts are mixed into paper bales and then run through the pulping process, the BPA becomes aerosolized and distributed in process water. Workers handling contaminated pulp, operating the machinery, or managing wastewater at recycling plants may face elevated exposure — occupational exposure that is almost entirely unquantified in current research.
...
Several major retailers have moved this direction: Starbucks, Target, and Whole Foods, among others, have [restricted bisphenol paper nationally](/articles/which-retailers-use-bpa-free-receipt-paper) ahead of the law.

For businesses in Washington State, the [2026 bisphenol ban](/articles/washington-state-receipt-paper-ban-compliance-guide) has already resolved this for receipts printed there: paper distributed in the state must now be phenol-free, which eliminates the BPA contamination problem at the source. Phenol-free thermal paper *can* be recycled without the BPA contamination concern, though it still generates paper waste. California's AB 1604, currently moving through the legislature, would extend similar requirements statewide by 2027–2028. Our [California AB 1604 compliance guide](/articles/california-ab-1604-compliance-guide) covers what businesses there need to do to prepare.
...
*For more on the health effects of BPA exposure from receipts, see [The Science of Bisphenols](/articles/the-science-of-bisphenols). For workers who handle receipts regularly, the [2026 Cashier Safety Guide](/articles/2026-cashiers-safety-guide) covers practical protective steps. For business owners navigating the new Washington State requirements, see the [Washington State Receipt Paper Compliance Guide](/articles/washington-state-receipt-paper-ban-compliance-guide).*
